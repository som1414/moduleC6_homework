let resultNode = document.querySelector('.btn_icon');
...
function change_icon() {
    if (resultNode.classList.contains('nofill')) {
        resultNode.classList.remove('nofill');
        resultNode.innerHTML = ico2;
    } else {
        resultNode.classList.add('nofill');
        resultNode.innerHTML = ico1;
    }
}

const btnStart = document.querySelector('.j-btn-test');
